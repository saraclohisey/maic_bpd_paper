...
Research often uses rodent models of BPD, exposing neonatal mice or rats to hyperoxia, mimicking lung injury. This approach effectively captures aspects of inflammation and oxidative stress but may not fully replicate the multifactorial nature of BPD. A full-term human (36+ weeks post-conception) is born early in the alveolarization stage of lung development, with 10% of the total alveoli they will develop in their lifetime (REF). Rodents are born during the saccular stage with alveolarization beginning approximately 5 days after birth (REF). A key difference is that rodent lungs are primed for gas exchange at this stage in development as the animal must survive outside of the womb (REF). In contrast, human lungs are not designed for gas exchange in these earlier stages of development. This brings into question the relevance of multi-omic research using rodent models aimed toward identifying potential therapeutic targets in BPD. To address this question, this study compares systematically collated information from both human and rodent studies.
